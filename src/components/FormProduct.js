...
export default function FormProduct({ setOpen, setAlert, product }) {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      images: ['https://images.pexels.com/photos/16233515/pexels-photo-16233515/free-photo-of-fashion-man-people-model.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'],
    };
